...
export const metadata: Metadata = {
  title: 'ExcuseDrawer - Generate an excuse right now!',
  description: 'You badly need an excuse? Generate one right now!',
}
    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="navbar bg-base-100">
          <Link href="/" className="btn btn-ghost text-xl">ExcuseDrawer</Link>
        ...
        <footer className="footer items-center p-4 bg-neutral text-neutral-content">
          <aside className="items-center grid-flow-col">
            ...
            <p>ExcuseDrawer - </p>
            <p className="text-xs">Made with <span className="text-red-500">♥</span> API by <a href="https://excuser-three.vercel.app/" className="text-blue-500">Excuser</a></p>
          </aside> 
